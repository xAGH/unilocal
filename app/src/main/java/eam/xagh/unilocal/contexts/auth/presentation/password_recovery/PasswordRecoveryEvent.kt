...
sealed interface PasswordRecoveryEvent {
    ...
    data class ValidateRecoveryCode(val code: String, val nicknameOrEmail: String): PasswordRecoveryEvent
    ...
    data class RecoveryPassword(val nicknameOrEmail: String , val newPassword: String) : PasswordRecoveryEvent
